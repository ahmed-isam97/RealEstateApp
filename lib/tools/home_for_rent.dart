...
class home_for_rent extends GetView<PropertiesController> {
  @override
  Widget build(BuildContext context) {
    print(controller.categoryForRent);
    Get.find<checkcontroller>();
    return Obx(() => controller.isLoaded.value
        ? ListView.builder(
      itemCount: controller.categoryForRent.length,
          ...
          child: Card(
            child: Column(children: [
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child:
                    Text("${controller.categoryForRent[index].location}"),
                  ),
                  Text("${controller.categoryForRent[index].category}",
                      style: TextStyle(
                          color: Color(0xFF1F5753),
              ...
              Row(
                children: [
                  Padding(
                    ...
                    const EdgeInsets.fromLTRB(30.0, 0.0, 30.0, 0.0),
                    child: Text(
                      "${controller.categoryForRent[index].status}",
              ...
              Padding(
                ...
                child: Text(
                  "\$" + "${controller.categoryForRent[index].price}" + "/m",
                  style: TextStyle(
                    color: Color(0xFF1F5753),
                    fontWeight: FontWeight.bold,
                    fontSize: 16.0,
